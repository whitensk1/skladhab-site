  ...
  */
  const contactCloak = (function () {
    ...
    const BAG = {
      ...
      /* public site email: info@fbo-fbs.ru */
      m: [122, 89, 195, 172, 209, 117, 85, 202, 238, 247, 113, 68, 139, 177, 228],
      /* lead form destination: same mailbox */
      l: [122, 89, 195, 172, 209, 117, 85, 202, 238, 247, 113, 68, 139, 177, 228],
    };
    const unveil = (id) => {
      const arr = BAG[id];
      if (!arr) return "";
